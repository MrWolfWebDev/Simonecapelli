...
if ($_SESSION['auth'] == 1):
    ...
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
            ...
            <title>Aggiungi Nuova Gara</title>
            <!-- jQuery & jQueryUI -->
        ...
        <body>
            <form action="addgara.php" method="post" enctype='multipart/form-data'>
                <table align= "center">
                    ...
                    <tr><td>Link Gara</td><td colspan="3"><input type="text" name="link" size="75"/></td></tr>
            ...
            if (isset($_POST) && !empty($_POST)) {
                ...
                if (!$empty) {
                    ...
                    $insertGara = "INSERT INTO `gare`(`DataGara`, `LuogoGara`, `DescGara`, `LinkGara`, `TitoloGara`) VALUES ('$data','$luogo','$descrizione','$link','$titolo')";
